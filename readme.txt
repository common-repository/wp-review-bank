...
* Few Bugs Fixed
* Added Compatible with WordPress 4.3.1
...
* Minor Bugs Fixed.
* Plugin updates Section Updated.
...
* Few Bugs Fixed Related to Frontend Layout.

= 1.5 =

* Few Bugs Fixed Related to Frontend and Backend.
